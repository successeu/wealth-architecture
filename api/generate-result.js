...
YOUR COMMUNICATION STYLE (T. Harv Eker Method):
...
- Be DIRECT and BLUNT but with empathy: "I'm not here to be your friend. I'm here to be your coach."
...
Return ONLY valid JSON:
{
  ...
  "transitionToSolution": "..."
    ...
    try {
        ...
        // Rich fallback narratives for each stage (T. Harv Eker voice)
        const stageNarratives = {
            'Survival Mode': {
                whyThisIsHappening: `${truth.firstName}, here's something I want you to really get: the lack of money is NEVER the problem. It's a symptom. Your financial blueprint - the subconscious programming you picked up around money - is set for survival, not success. This isn't your fault. Somewhere along the way, you heard things like "money doesn't grow on trees" or "we can't afford it." You saw people stressed about bills. And that got installed. Rich people believe "I create my life." People stuck in survival mode believe "life happens to me." That belief is running you right now. The good news? Beliefs can be changed.`,
                ...
                ifNothingChanges: `I'm going to be straight with you because I care about your success. If you keep doing what you've been doing, you'll keep getting what you've been getting. Period. Five years from now, you'll have a bit more income but the same stress. Ten years from now, same story. The gap between where you are and where you want to be won't shrink on its own. Your blueprint will keep resetting you to survival mode like a thermostat. And here's the hard truth: time is the one asset you can never get back. Every year you stay stuck is a year you'll never recover.`,
                transitionToSolution: `But here's what I want you to hold onto, ${truth.firstName}: you've already done something most people never do. You looked honestly at your situation. You got clear. That's the first step in the reconditioning process: AWARENESS. You can't change what you're not aware of. Now comes the real work - rewiring your blueprint for wealth instead of survival. Your ${truth.timeframe.toLowerCase()} timeline tells me you're ready to take action. The question is: are you committed to being rich, or do you just WANT to be rich? Because wanting is weak. Commitment is powerful. And you deserve to be rich.`
            },
            'Stability Trap': {
                whyThisIsHappening: `${truth.firstName}, let me tell you what I see: you're playing the money game NOT TO LOSE instead of playing to WIN. And that right there is the difference between the wealthy and the middle class. You're doing all the "responsible" things - steady job, decent savings, playing it safe. But here's the uncomfortable truth: the same cautious blueprint that got you here is now your ceiling. Rich people focus on their NET WORTH. Middle-class people focus on their WORKING INCOME. You've been trading time for money, and no matter how much time you trade, you can't get ahead. This isn't about working harder. It's about thinking BIGGER.`,
                ...
                ifNothingChanges: `I'm not here to be your friend, ${truth.firstName}. I'm here to be your coach. Friends tell you what you want to hear. Coaches tell you what you NEED to hear. So here it is: if nothing changes, nothing changes. You'll keep earning well, keep saving responsibly, and keep wondering why others with similar incomes are pulling ahead. The gap between comfortable and FREE will grow wider every year. And the most frustrating part? You'll KNOW something is off, but you won't be able to put your finger on it. That's your blueprint protecting itself. That's the Stability Trap doing its job.`,
